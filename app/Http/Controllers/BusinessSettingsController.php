...
class BusinessSettingsController extends Controller
{
      function __construct(){
        $this->middleware('permission:setup_configration', ['only' => ['update','updateActivationSettings','general_setting','activation','payment_method','file_system','social_login','smtp_settings','google_analytics','google_recaptcha','facebook_chat','env_key_update','payment_method_update','google_analytics_update','google_recaptcha_update','facebook_chat_update','facebook_pixel_update']]);
    }
    ...
    public function shipping_cost(){
            	return view('backend.shipping_cost');
    }
