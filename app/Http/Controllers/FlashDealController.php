...
class FlashDealController extends Controller
{
    function __construct(){
        ...
        $this->middleware('permission:markiting', ['only' => ['create','store']]);
        $this->middleware('permission:markiting', ['only' => ['edit','update']]);
        $this->middleware('permission:markiting', ['only' => ['destroy']]);
        $this->middleware('permission:markiting', ['only' => ['update_status']]);
        $this->middleware('permission:markiting', ['only' => ['update_featured']]);
        $this->middleware('permission:markiting', ['only' => ['product_discount']]);
        $this->middleware('permission:markiting', ['only' => ['product_discount_edit']]);
        }
    /**
