...
class LanguageController extends Controller
{
    function __construct(){
        $this->middleware('permission:setup_configration', ['only' => ['index','store']]);
        $this->middleware('permission:setup_configration', ['only' => ['create','store']]);
        $this->middleware('permission:setup_configration', ['only' => ['edit','update']]);
        $this->middleware('permission:setup_configration', ['only' => ['destroy']]);
        $this->middleware('permission:products', ['only' => ['update_rtl_status','key_value_store']]);
        }
