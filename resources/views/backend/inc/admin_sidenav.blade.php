        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                              ...
                              <li class="aiz-side-nav-item">
                                <a href="{{route('business_settings.shipping_cost')}}" class="aiz-side-nav-link">
                ...
                @if (  auth()->user()->hasPermissionTo('customers')  )                
                    ...
                    @if (  auth()->user()->hasPermissionTo('business cards')  )                

                <li class="aiz-side-nav-item">
                    <a href="{{ route('cards.index') }}" class="aiz-side-nav-link">
                        <i class="las la-id-card aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Business Cards') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                
                </li>
                @endif
                @if (  auth()->user()->hasPermissionTo('sellers')  )                
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                             ...
                             <li class="aiz-side-nav-item">
                                <a href="{{ route('vendpackeges.index') }}" class="aiz-side-nav-link">
                ...
                @if (  auth()->user()->hasPermissionTo('markiting')  )                
                ...
                @if (  auth()->user()->hasPermissionTo('club point')  )                
                ...
                <!-- Website Setup -->
                @if (  auth()->user()->hasPermissionTo('website seting')  )                
                ...
                @if (  auth()->user()->hasPermissionTo('setup_configration')  )                
                ...
                <!-- Staffs -->
                @if (  auth()->user()->hasPermissionTo('staffs')  )                
                ...
                <li class="aiz-side-nav-item">
                    ...
                    @endif
                    @if (  auth()->user()->hasPermissionTo('addon maneger')  )                
