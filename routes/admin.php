...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    ...
    Route::post('/tessttttt', 'LanguageController@testt')->name('test.test');
	...
	Route::get('sellers_category/{id}','SellerController@index2')->name('seller_cat');
	...
	Route::post('/update_flash', 'GeneralSettingController@update_flash')->name('business_settings.update_flash');
	Route::resource('vendpackeges','VendorPackegeController');
	...
	Route::get('shipping_cost', 'BusinessSettingsController@shipping_cost')->name('business_settings.shipping_cost');
	...
	Route::resource('coupon','CouponController');
		Route::resource('color','ColorcardController');
    ...
    Route::post('/sellers/verfy', 'SellerController@updateverfy')->name('sellers.verfy');
