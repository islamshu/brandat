...
Route::prefix('v3/auth')->namespace('Api\V3')->middleware(['changeLanguage','header_request_env'])->group(function () {
...
Route::prefix('v3')->namespace('Api\V3')->middleware(['changeLanguage','header_request_env'])->group(function () {
